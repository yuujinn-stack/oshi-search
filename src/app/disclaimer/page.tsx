    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-8 text-sm text-gray-700 leading-relaxed">
        ...
        <section>
          ...
          <p>
            当サイトでは、商品やサービスを紹介する際にアフィリエイト広告を利用する場合があります。
            現在は楽天市場・楽天ブックス等のアフィリエイトプログラムに参加しているほか、提携している動画配信サービス（VOD）の広告を掲載する場合があります。
            当サイト内のリンクを経由して商品購入やサービスへの申込みが行われた場合、当サイトが紹介料を受け取る場合があります。
            アフィリエイト広告が表示される箇所には「PR」の表示を付けています。
          </p>
          <p className="mt-2">
            価格・サービス内容・キャンペーン等の最新情報は、リンク先の公式サイトでご確認ください。
          </p>
          <p className="mt-2">
