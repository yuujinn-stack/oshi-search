...
const CREATE_STATEMENTS = [
  ...
  sql`CREATE INDEX IF NOT EXISTS ap_vod_service_idx ON affiliate_programs (vod_service)`,
  sql`CREATE INDEX IF NOT EXISTS ap_is_active_idx ON affiliate_programs (is_active)`,
  sql`CREATE TABLE IF NOT EXISTS affiliate_creatives (
    id               SERIAL PRIMARY KEY,
  ...
  sql`CREATE INDEX IF NOT EXISTS ac_program_id_idx ON affiliate_creatives (program_id)`,
  sql`CREATE INDEX IF NOT EXISTS ac_is_active_idx ON affiliate_creatives (is_active)`,
  sql`CREATE TABLE IF NOT EXISTS affiliate_placements (
    id           SERIAL PRIMARY KEY,
